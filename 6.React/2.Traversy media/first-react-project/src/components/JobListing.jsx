  ...
  return (
    <div key={id} className="bg-white rounded-xl shadow-md relative">
      <div className="p-4">
        ...
        <div className="mb-5">
          {showFullDesc ? description : description.substring(0, 90 ) + " ..."}
        </div>

        <button onClick={() => { setShowFullDesc( prevState => !prevState ) }} className='bg-indigo-400 rounded-sm mb-5 py-1 px-2'  >
